            ...
            <div class="card-body">
                <table class="table table-sm">
                    <tbody>
                        ...
                        <tr>
                            <td>Nilai Pagu</td>
                            <td>@currency($pembangunan->nilai_pagu)</td>
                        </tr>
                        <tr>
                            <td>Latitude</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $pembangunan->panjang_pekerjaan}} M</td>
                        </tr>
                        <tr>
                            <td>Gambar</td>
                            <td> @if($pembangunan->gambar)
                                <img src="{{asset('storage/' . $pembangunan->gambar)}}" width="300px" height="200px" />
                                @endif
                            </td>
                        </tr>
                    </tbody>
