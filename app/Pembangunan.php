...
class Pembangunan extends Model
{
    ...
    public function getMapPopupContentAttribute()
    {
        ...
        $mapPopupContent .= '<div class="my-2"><strong>'.('lokasi').':</strong><br>'.$this->address.'</div>';
        $mapPopupContent .= '<div class="my-2"><strong>'.('nilai kontrak').':</strong><br>'.$this->nilai_kontrak.'</div>';
        $mapPopupContent.= '<img class="zoom" src="'.asset('storage/'.$this->gambar).'" width="96px">';
